...
| [공개 레포 이사 런북](6-도구/공개레포-이사.md)                        | **한 번 하는 이사** — 트리 밖의 것(이슈·라벨·마일스톤·시크릿·변수·러너·레포 설정)을 새 공개 레포로 옮기는 순서·확인·되돌리기. 이사 뒤 개발은 공개 레포에서 계속된다 (#360) |
| [공개 트리 이관 도구](6-도구/공개배포-릴리스.md)                      | 그 이사의 한 걸음 — **현재 트리만** 히스토리 없이 밀어 넣는 1회용 도구 (`release_public.py`). 내용 게이트 · 드라이런 기본 · 못 막는 것 (#360) |
