...
-- tn_workspace_menu 만 부여하고 여기를 mbiz1001 로 두면 나머지 업무 화면(포트폴리오·스케줄러·리서치·터미널)이 안 보인다.
...
-- 사이드바가 조용히 빈다(#251). 두 목록의 대조는 tests/regressions/251-personal-workspace-menu.test.tsx.
