...
export const RAIL_ITEMS: readonly RailItem[] = [
  { id: "bench", label: "실험대", icon: "home", kind: "route", path: BENCH_PATH },
  {
    ...
    icon: "find",
    kind: "route",
    pending: "리서치 전체 폭 화면은 아직 없습니다 — 리서치 베팅에서 옵니다.",
    dividerAfter: true,
  },
  { id: "bot", label: "봇", icon: "box", kind: "panel" },
  {
    ...
    kind: "panel",
    expandable: true,
    pending: "에이전트 대화는 아직 없습니다 — 리서치 베팅에서 옵니다. 지금은 폭만 620px 까지 넓힐 수 있습니다.",
  },
  {
    id: "trades",
    label: "거래 로그",
    icon: "bulletlist",
    kind: "panel",
    pending: "거래 로그는 아직 없습니다 — 봇 실행 엔진이 신호를 남기기 시작하면 옵니다.",
  },
  {
    id: "rules",
    label: "내 기준",
    icon: "check",
    kind: "panel",
    pending: "내 기준은 아직 없습니다 — 봇 검증 베팅에서 옵니다.",
    dividerAfter: true,
  },
