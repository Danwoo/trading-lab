...
/**
 * 패널 하나의 틀 — 배치·크기·접힘·닫기 chrome 과 출처 표시를 소유한다 (설계 §3.5·§4).
...
export function PanelFrame({
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden border border-slate-line bg-slate-panel">
      <div className="group panel-drag-handle flex flex-shrink-0 items-center justify-between gap-2 border-b border-slate-line px-2 py-1 font-mono text-xs">
